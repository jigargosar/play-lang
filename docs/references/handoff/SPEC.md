...
play is a small, opinionated language that transpiles to JavaScript. It is designed to be written, run, and learned inside its own live editor — the editor is a first-class part of the language, not an afterthought. You type, you see. The feedback loop is the product.
